 ...
 *represents the price of the ith ice cream base flavor. toppingCosts, an
 *integer array of length m, where each toppingCosts[i] is the price of one of
 *the ith topping. target, an integer representing your target price for
 *dessert.
 *
...
class Solution {
private:
    int abs_min(int x, int y, int z) { return abs_min(x, abs_min(y, z)); }
