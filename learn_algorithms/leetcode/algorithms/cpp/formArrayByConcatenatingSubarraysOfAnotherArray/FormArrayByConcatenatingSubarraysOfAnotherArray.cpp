 ...
 *(i-1)^th subarray appears before the i^th subarray in nums (i.e. the subarrays
 ...
 *the 1^st one as [1,-1,0,1,-1,-1,3,-2,0]. These subarrays are disjoint as they
 *share no common nums[k] element.
 *
 * Example 2:
 *
 ...
 *groups. [10,-2] must come before [1,2,3,4].
 *
 * Example 3:
 *
 ...
 *[7,7,1,2,3,4,7,7] is invalid because they are not disjoint. They share a
 *common elements nums[4] (0-indexed).
 *
 * Constraints:
 *
 * 	groups.length == n
...
public:
    bool canChoose(vector<vector<int>> &groups, vector<int> &nums) {
        ...
        //  lens[n] = len(groups[n])
        // so that, we can quickly know whether there still has enough room to match
        // rest groups
