...
/*
 * Acuatlly, everything I've already implemented in "Basic Calculator"(RPN way
 * and Design pattern way). So, here, I just use the quick-dirty way - just like
 * the "two stacks solution" in "Basic Calulator".
 */
