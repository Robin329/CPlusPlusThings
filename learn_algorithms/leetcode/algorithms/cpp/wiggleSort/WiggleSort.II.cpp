 ...
 *1, 6]. (2) Given nums = [1, 3, 2, 2, 3, 1], one possible answer is [2, 3, 1,
 *3, 1, 2].
 *
 *     Note:
...
public:
    ...
    //
    // After checked the discussion of Leetcode, I found there is a really
    // brilliant idea which used a tricky idea - virtual index.
    //
