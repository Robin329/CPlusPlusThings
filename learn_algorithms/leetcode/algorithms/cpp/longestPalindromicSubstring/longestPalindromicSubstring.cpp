...
string longestPalindrome_dp_way(string s) {
    ...
    // Construct a matrix, and consdier matrix[i][j] as s[i] -> s[j] is Palindrome
    // or not.
    ...
    for (int i = n - 1; i >= 0; i--) {
        for (int j = i; j < n; j++) {
            ...
            //   3) the length from i to j > 3, then, check s[i]==s[j] &&
            //   matrix[i+1][j-1]
...
string longestPalindrome_dp_opt_way(string s) {
    ...
    for (int i = 0; i < n; i++) {
        ...
        for (int j = 0; j <= i; j++) {
            ...
            //   3) the length from j to i > 3, then, check s[i]==s[j] &&
            //   matrix[i-1][j+1]
...
int main(int argc, char **argv) {
    ...
    s = "321012321001232100123210012321001232100123210012321001232100123210012321"
        ...
        "012321001232100123210012321001232100123210012321001232100123210012321001"
        "232100123210012321001232100123210012321001232100123210012321001232100123"
        "210012321001232100123210012321001232100123210012321001232100123210012321"
        "001232100123210012321001232100123210012321001232100123210012321001232100"
        "123210012321001232100123210012321001232100123210012321001232100123210012"
        "321001232100123210012321001232100123210012321001232100123210012321001232"
        "100123210012321001232100123210012321001232100123210012321001232100123210"
        "012321001232100123210012321001232100123210012321001232100123210012321001"
        "232100123210012321001232100123210123210012321001232100123210123";
    cout << s << " : " << longestPalindrome(s) << endl;

    //"illi"
    s = "iptmykvjanwiihepqhzupneckpzomgvzmyoybzfynybpfybngttozprjbupciuinpzryritf"
        "myxyppxigitnemanreexcpwscvcwddnfjswgprabdggbgcillisyoskdodzlpbltefiz";
    cout << s << " : " << longestPalindrome(s) << endl;
