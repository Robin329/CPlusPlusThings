...
public:
    /*
     *  profits[trans, day]
     *  - `trans` represents the number of transactions we've done so far. ( 0 <=
     * trans <= k )
     ...
     *                              profits[trans, day-1], // same times
     * transactions, but one days before. profits[trans-1, i-1] + (prices[day] -
     * prices[i]) // for all of (0 <= i < day )
     *                                                                                //
