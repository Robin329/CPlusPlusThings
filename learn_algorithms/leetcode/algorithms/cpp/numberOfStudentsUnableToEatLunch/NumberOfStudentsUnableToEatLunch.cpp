// Source :
// https://leetcode.com/problems/number-of-students-unable-to-eat-lunch/ Author
// : Hao Chen Date   : 2021-05-10
 ...
 *and students[j] is the preference of the jth student in the initial queue (j =
 *0 is the front of the queue). Return the number of students that are unable to
 *eat.
 *
 * Example 1:
 *
