...
//    a, a, b, a
//
//   You can see this algorithm still can be optimized, becasue there are some
//   dupliation. (  The optimization you can see the "Palindrome Partitioning
//   II" )
//
...
void partitionHelper(string &s, int start, vector<string> &output, vector<vector<string>> &result) {
    ...
    for (int i = start; i < s.size(); i++) {
        if (isPalindrome(s, start, i) == true) {
            ...
            // take out the current palindrome substring, in order to check longer
            // substring.
            output.pop_back();
        }
    }
