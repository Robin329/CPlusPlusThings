...
public:
     ...
     * ==============================
     *
     * One solution would be to store the position of the next non-zero element of
     * the array. Every position of the array, starting with position 0, must
     * store this next non-zero element until we can no more do that, case in
     * which we need to add the remaining zeros that we skipped.
     *
     *
     * Time Complexity: O(N)
