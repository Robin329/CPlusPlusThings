 ...
 * ["John", "johnsmith@mail.com", "john_newyork@mail.com"], ["Mary",
 *"mary@mail.com"]] Output: [["John", 'john00@mail.com',
...
public:
    ...
    string find(unordered_map<string, string> &emails_chains, string email) {
    ...
    bool join(unordered_map<string, string> &emails_chains, string &email1, string &email2) {
...
// So, we allocated the ID for each email, and compare the ID would save the
// time.
//
