...
//
//  Obviously, the easist way is sort the array, however the run-time complexity
//  is O(nlogn)
//
//  If we cannot use the sort algorithm, then it seems we have to use O(n^2)
//  solution.
//
...
//      ......
//
//  We can see, the search is really heavy, and the best data structure for
//  seaching is HashMap. hash map is O(1) run-time complexity for seaching.
//
