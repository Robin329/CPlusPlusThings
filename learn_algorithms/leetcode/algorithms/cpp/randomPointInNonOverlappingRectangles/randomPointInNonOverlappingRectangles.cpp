...
public:
    ...
    vector<int> points_until;    // value of element 'e' = num of points in all
                                 // rects before 'e', including it
    ...
    vector<int> pick() {
        ...
        int rect =
                upper_bound(points_until.begin(), points_until.end(), ind) - points_until.begin();
