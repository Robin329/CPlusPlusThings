 ...
 *
 *    You have to buffer the extra data return from `read4()` API, which is for
 * next call for `read()` .
 */
...
public:
    ...
    // The read1 implementation is from the `Read N Characters Given Read4`
    // problem Add the feature - write the extra char(s) into RingBuffer
