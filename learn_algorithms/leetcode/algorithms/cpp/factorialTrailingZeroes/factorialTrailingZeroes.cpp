 ...
 * ...
 *  4. So, if we take all the numbers with 5 as a factor, we'll have way more
 * than enough even numbers to pair with them to get factors of 10
 *
 * **Example One**
 *
 * How many multiples of 5 are between 1 and 23?
 * There is 5, 10, 15, and 20, for four multiples of 5. Paired with 2's from the
 * even factors, this makes for four factors of 10, so: **23! has 4 zeros**.
 *
 *
 * **Example Two**
 *
 ...
 *
 * because   100 ÷ 5 = 20, so, there are twenty multiples of 5 between 1 and
 * 100.
 *
 * but wait, actually 25 is 5×5, so each multiple of 25 has an extra factor of
 * 5, ( e.g. 25 × 4 = 100，which introduces extra of zero )
 *
