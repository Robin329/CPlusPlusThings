 ...
 *single pass? Space complexity should be O(n). Can you do it like a boss? Do it
 *without using any builtin function like
 * __builtin_popcount  in c++ or in any other language.
 *
 *   You should make use of what you have produced already.
 *   Divide the numbers in ranges like [2-3], [4-7], [8-15] and so on. And try
 *to generate new range from previous. Or does the odd/even status of the number
...
public:
     ...
     * 2 = 10 + 0  and  3= 10 + 1, then we can reuse the bits_cnt[0] and
     * bits_cnt[1]
     *
     *   bits_cnt[2] => 0010 => 0010 + 0 => 1 + bits_cnt[0];
     *   bits_cnt[3] => 0011 => 0010 + 1 => 1 + bits_cnt[1];
     *
     * if the number has 3 bits (4,5,6,7), then we can split the binary to two
     * parts, 4 = 100 + 0,  5 = 100 + 01, 6= 100 + 10, 7 = 100 +11 then we can
     * reuse the bits_cnt[0] and bits_cnt[1]
     *
