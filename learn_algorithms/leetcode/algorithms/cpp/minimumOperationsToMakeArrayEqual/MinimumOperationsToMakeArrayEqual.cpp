// Source :
// https://leetcode.com/problems/minimum-operations-to-make-array-equal/ Author
// : Hao Chen Date   : 2020-10-03
...
public:
    int minOperations(int n) {
        ...
        // calculate the different between n and all of the odd number which less
        // than `average`
        //  (n - 1) + (n - 3) + (n - 5) + (n - 7) ...
