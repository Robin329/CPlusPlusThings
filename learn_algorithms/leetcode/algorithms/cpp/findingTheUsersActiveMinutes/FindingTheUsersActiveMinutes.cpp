 ...
 *they have a UAM of 2 (minute 5 is only counted once). The user with ID=1
 *performed actions at minutes 2 and 3. Hence, they have a UAM of 2. Since both
 *users have a UAM of 2, answer[2] is 2, and the remaining answer[j] values are
 *0.
 *
 * Example 2:
 *
