 ...
 *
 *       2.1) for [1,2,1,2,1] you can return either 1 or 3, because both them
 * are peak elements
 *
 *       2.1) for [1,2,3,2,4,2,1] it should return 4, because num[4] is the real
 * peak.  but Leetcode accept either 2 or 4
 *
 */
