...
public:
    int findNthDigit(int n) {
        ...
        //
        //   For examples:
        //      n = 20;    digits_cnt_prev = 9,            digits_cnt = 9+90*2 =
        //      189,         base = 2; n = 500;   digits_cnt_prev = 9+90*2 = 189,
        //      digits_cnt = 9+90*2+900*3 = 2889,  base = 3; n = 2000;
        //      digits_cnt_prev = 9+90*2 = 189, digits_cnt = 9+90*2+900*3 = 2889,
        //      base = 3;
        //
        ...
        //
        // and we can use `digits_cnt_prev` to know the previous rangs produce how
        // many digits.
        //     n = 20, the previous ranges produce 9 digits, so there needs 20-9 =
        //     11 digits in [10 - 99] n = 500, the previous ranges produce 189
        //     digits, so there needs 500-189 = 311 digits in [100-999]
        //
        // the `base` told us in current ranges, each number can have how many
        // digits. then we can locate the target number.
        //     n = 20,
        //       (n - digits_cnt_prev) / base = (20 - 9 ) / 2 = 5, so, [10 - 14]
        //       produces 10 digits (ZERO-based), now, we have 1 digits left, it is
        //       the first digit of the target number 15.
        //
        //     n = 500,
        //       (n - digits_cnt_prev) / base = (500 - 189) / 3 = 103, so, [100 -
        //       202] produces 309 digits(ZERO-based). now, we have (500 - 189 -
        //       309) = 2 digits left, it is the second digit of the target number
        //       203.
        //
