 ...
 *block of length 3. The 2nd block is "456". Joining the blocks gives "123-456".
 *
 * Example 2:
 *
 ...
 * Step 1: There are more than 4 digits, so group the next 3 digits. The 1st
 *block is "123". Step 2: There are 4 digits left, so split them into two blocks
 *of length 2. The blocks are "45" and "67". Joining the blocks gives
 *"123-45-67".
 *
 * Example 3:
 *
