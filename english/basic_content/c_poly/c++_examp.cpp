...
{
public:
    virtual void f() // Virtual function implementation, virtual keyword in
                     // subclass can not be appearence
    {
...
int main() {
    ...
    pa = &b;    // The parent class pointer points to the subclass object, which is
                // implemented in polymorphism
