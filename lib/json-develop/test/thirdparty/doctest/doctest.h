...
#define DOCTEST_ASSERT_IMPLEMENT_2(assert_type, ...)                                                                  \
    ...
    DOCTEST_WRAP_IN_TRY(_DOCTEST_RB.setResult(doctest::detail::ExpressionDecomposer(doctest::assertType::assert_type) \
                                              << __VA_ARGS__))                                                        \
...
#define DOCTEST_BINARY_ASSERT(assert_type, comparison, ...)                                                            \
    doctest::detail::binary_assert<                                                                                    \
            doctest::detail::binaryAssertComparison::comparison>(doctest::assertType::assert_type, __FILE__, __LINE__, \
