...
private:
    ...
    sp<ALooper> getLooper() const { return mLooper.promote(); }
...
struct AMessage : public RefBase {
    ...
    bool findRect(const char *name, int32_t *left, int32_t *top, int32_t *right,
...
private:
    ...
    void setObjectInternal(const char *name, const sp<RefBase> &obj, Type type);
