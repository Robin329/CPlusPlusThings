...
int main(int /*argc*/, char* /*argv*/[]) {
    ...
    uint32_t data[] = {6504993, 2179683, 2179683, 2179683, 2179683, 8421504, 2179683, 2179683,
                       2179683, 2179683, 2179683, 2179683, 2179683, 2179683, 2179683, 8421504};
    scope_block<uint8_t> yuv;

    printf("RGB-888X: ");
    uint8_t* rgb = (uint8_t*)data;
    for (size_t i = 0; i < sizeof(data); ++i) printf("%02X ", rgb[i]);
    printf("\n");
