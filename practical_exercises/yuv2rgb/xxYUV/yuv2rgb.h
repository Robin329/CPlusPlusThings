...
//------------------------------------------------------------------------------
inline void yuv2rgb_yu12(int width, int height, const void* yuv, void* rgb, bool fullRange = true, int rgbWidth = 3,
                         bool rgbSwizzle = false, int strideRGB = 0, int alignWidth = 16, int alignHeight = 1,
                         int alignSize = 1) {
...
//------------------------------------------------------------------------------
inline void yuv2rgb_yv12(int width, int height, const void* yuv, void* rgb, bool fullRange = true, int rgbWidth = 3,
                         bool rgbSwizzle = false, int strideRGB = 0, int alignWidth = 16, int alignHeight = 1,
                         int alignSize = 1) {
    yuv2rgb_parameter parameter = {
            .width = width,
...
//------------------------------------------------------------------------------
inline void yuv2rgb_nv12(int width, int height, const void* yuv, void* rgb, bool fullRange = true, int rgbWidth = 3,
                         bool rgbSwizzle = false, int strideRGB = 0, int alignWidth = 16, int alignHeight = 1,
                         int alignSize = 1) {
    yuv2rgb_parameter parameter = {
            .width = width,
...
//------------------------------------------------------------------------------
inline void yuv2rgb_nv21(int width, int height, const void* yuv, void* rgb, bool fullRange = true, int rgbWidth = 3,
                         bool rgbSwizzle = false, int strideRGB = 0, int alignWidth = 16, int alignHeight = 1,
                         int alignSize = 1) {
    yuv2rgb_parameter parameter = {
            .width = width,
