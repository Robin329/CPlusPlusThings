...
void yuv2rgb_amx(int width, int height, const void* y, const void* u, const void* v, int strideY, int strideU,
                 int strideV, void* rgb, int strideRGB) {
    ...
    for (int h = 0; h < halfHeight; ++h) {
        ...
        const unsigned char* y1 = y0 + strideY;
        y = y1 + strideY;
        const unsigned char* u0 = (unsigned char*)u;
        u = u0 + strideU;
        const unsigned char* v0 = (unsigned char*)v;
        v = v0 + strideV;
        unsigned char* rgb0 = (unsigned char*)rgb;
        unsigned char* rgb1 = rgb0 + strideRGB;
        rgb = rgb1 + strideRGB;
        ...
        for (int w = 0; w < halfWidth128; ++w) {
            ...
            amx_ldx(/*.memory_offset = */ (uint64_t)y0 + 64, .register_index = 1);
            y0 += 128;
            amx_ldx(/*.memory_offset = */ (uint64_t)y1 + 0, .register_index = 2);
            amx_ldx(/*.memory_offset = */ (uint64_t)y1 + 64, .register_index = 3);
            y1 += 128;
            amx_ldx(/*.memory_offset = */ (uint64_t)u0 + 0, .register_index = 4);
            u0 += 64;
            amx_ldx(/*.memory_offset = */ (uint64_t)v0 + 0, .register_index = 5);
            v0 += 64;

            // Y
            amx_vecint(.offset_x = 0x000, .offset_y = 0x0C0, .offset_z = 32, .count_x = 1, .mask = 64, .extended = 11,
                       .shift_right = 7);
            amx_vecint(.offset_x = 0x000, .offset_y = 0x0C0, .offset_z = 40, .count_x = 1, .mask = 64, .extended = 11,
                       .shift_right = 7);
            amx_vecint(.offset_x = 0x000, .offset_y = 0x0C0, .offset_z = 48, .count_x = 1, .mask = 64, .extended = 11,
                       .shift_right = 7);
            amx_vecint(.offset_x = 0x040, .offset_y = 0x0C0, .offset_z = 34, .count_x = 1, .mask = 64, .extended = 11,
                       .shift_right = 7);
            amx_vecint(.offset_x = 0x040, .offset_y = 0x0C0, .offset_z = 42, .count_x = 1, .mask = 64, .extended = 11,
                       .shift_right = 7);
            amx_vecint(.offset_x = 0x040, .offset_y = 0x0C0, .offset_z = 50, .count_x = 1, .mask = 64, .extended = 11,
                       .shift_right = 7);
            amx_vecint(.offset_x = 0x080, .offset_y = 0x0C0, .offset_z = 36, .count_x = 1, .mask = 64, .extended = 11,
                       .shift_right = 7);
            amx_vecint(.offset_x = 0x080, .offset_y = 0x0C0, .offset_z = 44, .count_x = 1, .mask = 64, .extended = 11,
                       .shift_right = 7);
            amx_vecint(.offset_x = 0x080, .offset_y = 0x0C0, .offset_z = 52, .count_x = 1, .mask = 64, .extended = 11,
                       .shift_right = 7);
            amx_vecint(.offset_x = 0x0C0, .offset_y = 0x0C0, .offset_z = 38, .count_x = 1, .mask = 64, .extended = 11,
                       .shift_right = 7);
            amx_vecint(.offset_x = 0x0C0, .offset_y = 0x0C0, .offset_z = 46, .count_x = 1, .mask = 64, .extended = 11,
                       .shift_right = 7);
            amx_vecint(.offset_x = 0x0C0, .offset_y = 0x0C0, .offset_z = 54, .count_x = 1, .mask = 64, .extended = 11,
                       .shift_right = 7);
            ...
            amx_vecint(.offset_x = 0x000, .offset_y = 0x000, .offset_z = 0, .count_x = 1, .count_y = 1, .extended = 10,
                       .add = 1);
            amx_vecint(.offset_x = 0x040, .offset_y = 0x000, .offset_z = 4, .count_x = 1, .count_y = 1, .extended = 10,
                       .add = 1);
            amx_vecint(.offset_x = 0x080, .offset_y = 0x000, .offset_z = 8, .count_x = 1, .count_y = 1, .extended = 10,
                       .add = 1);
            amx_vecint(.offset_x = 0x0C0, .offset_y = 0x000, .offset_z = 12, .count_x = 1, .count_y = 1, .extended = 10,
                       .add = 1);
            amx_vecint(.offset_x = 0x100, .offset_y = 0x000, .offset_z = 16, .count_x = 1, .count_y = 1, .extended = 10,
                       .add = 1);
            amx_vecint(.offset_x = 0x140, .offset_y = 0x000, .offset_z = 20, .count_x = 1, .count_y = 1, .extended = 10,
                       .add = 1);
            amx_vecint(.offset_x = 0x180, .offset_y = 0x000, .offset_z = 24, .count_x = 1, .count_y = 1, .extended = 10,
                       .add = 1);
            amx_vecint(.offset_x = 0x1C0, .offset_y = 0x000, .offset_z = 28, .count_x = 1, .count_y = 1, .extended = 10,
                       .add = 1);
            ...
            amx_vecint(.offset_x = 0x1E0, .offset_y = 0x040, .offset_z = 0, .count_x = 1, .mask = 1, .extended = 6,
                       .shift_right = 8);
            amx_vecint(.offset_x = 0x000, .offset_y = 0x040, .offset_z = 1, .count_x = 1, .mask = 1, .extended = 6,
                       .shift_right = 8);
            amx_vecint(.offset_x = 0x020, .offset_y = 0x040, .offset_z = 4, .count_x = 1, .mask = 1, .extended = 6,
                       .shift_right = 8);
            amx_vecint(.offset_x = 0x040, .offset_y = 0x040, .offset_z = 5, .count_x = 1, .mask = 1, .extended = 6,
                       .shift_right = 8);
            amx_vecint(.offset_x = 0x060, .offset_y = 0x040, .offset_z = 8, .count_x = 1, .mask = 1, .extended = 6,
                       .shift_right = 8);
            amx_vecint(.offset_x = 0x080, .offset_y = 0x040, .offset_z = 9, .count_x = 1, .mask = 1, .extended = 6,
                       .shift_right = 8);
            amx_vecint(.offset_x = 0x0A0, .offset_y = 0x040, .offset_z = 12, .count_x = 1, .mask = 1, .extended = 6,
                       .shift_right = 8);
            amx_vecint(.offset_x = 0x0C0, .offset_y = 0x040, .offset_z = 13, .count_x = 1, .mask = 1, .extended = 6,
                       .shift_right = 8);
            amx_vecint(.offset_x = 0x0E0, .offset_y = 0x040, .offset_z = 16, .count_x = 1, .mask = 1, .extended = 6,
                       .shift_right = 8);
            amx_vecint(.offset_x = 0x100, .offset_y = 0x040, .offset_z = 17, .count_x = 1, .mask = 1, .extended = 6,
                       .shift_right = 8);
            amx_vecint(.offset_x = 0x120, .offset_y = 0x040, .offset_z = 20, .count_x = 1, .mask = 1, .extended = 6,
                       .shift_right = 8);
            amx_vecint(.offset_x = 0x140, .offset_y = 0x040, .offset_z = 21, .count_x = 1, .mask = 1, .extended = 6,
                       .shift_right = 8);
            amx_vecint(.offset_x = 0x160, .offset_y = 0x040, .offset_z = 24, .count_x = 1, .mask = 1, .extended = 6,
                       .shift_right = 8);
            amx_vecint(.offset_x = 0x180, .offset_y = 0x040, .offset_z = 25, .count_x = 1, .mask = 1, .extended = 6,
                       .shift_right = 8);
            amx_vecint(.offset_x = 0x1A0, .offset_y = 0x040, .offset_z = 28, .count_x = 1, .mask = 1, .extended = 6,
                       .shift_right = 8);
            amx_vecint(.offset_x = 0x1C0, .offset_y = 0x040, .offset_z = 29, .count_x = 1, .mask = 1, .extended = 6,
                       .shift_right = 8);
            ...
            amx_stz(/*.memory_offset = */ (uint64_t)rgb0 + 448, .register_index = 13);
            rgb0 += 128 * 4;
            ...
            amx_stz(/*.memory_offset = */ (uint64_t)rgb1 + 448, .register_index = 29);
            rgb1 += 128 * 4;
        }
    }
    amx_clr();
...
void yyy2rgb_amx(int width, int height, const void* y, int strideY, void* rgb, int strideRGB) {
    ...
    for (int h = 0; h < halfHeight; ++h) {
        ...
        for (int w = 0; w < halfWidth128; ++w) {
            ...
            // Load
            amx_ldx(.memory_offset = (uint64_t)y0 + 0, .register_index = 0);
            amx_ldx(.memory_offset = (uint64_t)y0 + 64, .register_index = 2);
            y0 += 128;
            amx_ldx(.memory_offset = (uint64_t)y1 + 0, .register_index = 4);
            amx_ldx(.memory_offset = (uint64_t)y1 + 64, .register_index = 6);
            y1 += 128;
            ...
            amx_vecint(.offset_x = 0x1E0, .offset_y = 0x000, .offset_z = 2, .count_x = 2, .extended = 12, .neg = 1,
                       .add = 1);
            amx_vecint(.offset_x = 0x060, .offset_y = 0x000, .offset_z = 10, .count_x = 2, .extended = 12, .neg = 1,
                       .add = 1);
            amx_vecint(.offset_x = 0x0E0, .offset_y = 0x000, .offset_z = 18, .count_x = 2, .extended = 12, .neg = 1,
                       .add = 1);
            amx_vecint(.offset_x = 0x160, .offset_y = 0x000, .offset_z = 26, .count_x = 2, .extended = 12, .neg = 1,
                       .add = 1);
            ...
            amx_stz(.memory_offset = (uint64_t)rgb0 + 448, .register_index = 11);
            rgb0 += 128 * 4;
            amx_stz(.memory_offset = (uint64_t)rgb1 + 0, .register_index = 16);
            amx_stz(.memory_offset = (uint64_t)rgb1 + 64, .register_index = 17);
            ...
            amx_stz(.memory_offset = (uint64_t)rgb1 + 448, .register_index = 27);
            rgb1 += 128 * 4;
        }
    }
    amx_clr();
...
//------------------------------------------------------------------------------
void yuv2rgb_yu12_amx(int width, int height, const void* yuv, void* rgb, bool fullRange, int rgbWidth, bool rgbSwizzle,
                      int strideRGB, int alignWidth, int alignHeight, int alignSize) {
    ...
    if (strideRGB == 0) strideRGB = rgbWidth * width;
    ...
    converter(width, height, yuv, (char*)yuv + sizeY, (char*)yuv + sizeY + sizeU, strideY, strideU, strideU, rgb,
              strideRGB);
}
//------------------------------------------------------------------------------
void yuv2rgb_yv12_amx(int width, int height, const void* yuv, void* rgb, bool fullRange, int rgbWidth, bool rgbSwizzle,
                      int strideRGB, int alignWidth, int alignHeight, int alignSize) {
    int strideY = align(width, alignWidth);
    int strideU = align(width, alignWidth) / 2;
    int sizeY = align(strideY * align(height, alignHeight), alignSize);
    ...
    converter(width, height, yuv, (char*)yuv + sizeY + sizeU, (char*)yuv + sizeY, strideY, strideU, strideU, rgb,
              strideRGB);
}
//------------------------------------------------------------------------------
void yuv2rgb_nv12_amx(int width, int height, const void* yuv, void* rgb, bool fullRange, int rgbWidth, bool rgbSwizzle,
                      int strideRGB, int alignWidth, int alignHeight, int alignSize) {
    ...
    converter(width, height, yuv, (char*)yuv + sizeY, (char*)yuv + sizeY + 1, strideYUV, strideYUV, strideYUV, rgb,
              strideRGB);
}
//------------------------------------------------------------------------------
void yuv2rgb_nv21_amx(int width, int height, const void* yuv, void* rgb, bool fullRange, int rgbWidth, bool rgbSwizzle,
                      int strideRGB, int alignWidth, int alignHeight, int alignSize) {
    int strideYUV = align(width, alignWidth);
    int sizeY = align(strideYUV * align(height, alignHeight), alignSize);
    int sizeUV = align(strideYUV * align(height, alignHeight) / 2, alignSize);
    ...
    converter(width, height, yuv, (char*)yuv + sizeY + 1, (char*)yuv + sizeY, strideYUV, strideYUV, strideYUV, rgb,
              strideRGB);
}
//------------------------------------------------------------------------------
