...
void yuv2rgb(int width, int height, const void* y, const void* u, const void* v, int strideY, int strideU, int strideV,
             void* rgb, int strideRGB) {
    ...
    for (int h = 0; h < halfHeight; ++h) {
        ...
        for (int w = 0; w < halfWidth8; ++w) {
            uint8x16_t y00lh = vld1q_u8(y0);
            y0 += 16;
            uint8x16_t y10lh = vld1q_u8(y1);
            y1 += 16;
            uint8x8_t y00;
            uint8x8_t y01;
            uint8x8_t y10;
            ...
            if (interleaved) {
                ...
                int8x16_t uv000 = vaddq_s8(vcombine_s8(vld1_u8(u0), vld1_u8(v0)), vdupq_n_s8(-128));
                u0 += 8;
                v0 += 8;
                u000 = vget_low_s8(uv000);
                v000 = vget_high_s8(uv000);
        ...
        if (componentRGB == 4) continue;
#elif HAVE_AVX512
        int halfWidth16 = (componentRGB == 4) ? halfWidth / 32 : 0;
        for (int w = 0; w < halfWidth16; ++w) {
            __m512i y00lh = _mm512_loadu_si512((__m512i*)y0);
            y0 += 64;
            __m512i y10lh = _mm512_loadu_si512((__m512i*)y1);
            y1 += 64;
            __m512i y00;
            __m512i y01;
            __m512i y10;
            ...
            if (interleaved) {
                if (firstU) {
                    __m512i uv00 = _mm512_loadu_si512((__m512i*)u0);
                    u0 += 64;
                    uv00 = _mm512_sub_epi8(uv00, _mm512_set1_epi8(-128));
                    u00 = _mm512_slli_epi16(uv00, 8);
                    v00 = uv00;
                } else {
                    __m512i uv00 = _mm512_loadu_si512((__m512i*)v0);
                    v0 += 64;
                    uv00 = _mm512_sub_epi8(uv00, _mm512_set1_epi8(-128));
                    u00 = uv00;
                ...
                __m256i u000 = _mm256_loadu_si256((__m256i*)u0);
                u0 += 32;
                __m256i v000 = _mm256_loadu_si256((__m256i*)v0);
                v0 += 32;
            ...
            __m512i dG = _mm512_add_epi16(_mm512_mulhi_epi16(u00, _mm512_set1_epi16(UG)),
                                          _mm512_mulhi_epi16(v00, _mm512_set1_epi16(VG)));
        ...
        for (int w = 0; w < halfWidth16; ++w) {
            __m256i y00lh = _mm256_loadu_si256((__m256i*)y0);
            y0 += 32;
            __m256i y10lh = _mm256_loadu_si256((__m256i*)y1);
            y1 += 32;
            __m256i y00;
            __m256i y01;
            __m256i y10;
            ...
            if (interleaved) {
                if (firstU) {
                    __m256i uv00 = _mm256_loadu_si256((__m256i*)u0);
                    u0 += 32;
                    uv00 = _mm256_sub_epi8(uv00, _mm256_set1_epi8(-128));
                    u00 = _mm256_slli_epi16(uv00, 8);
                    v00 = uv00;
                } else {
                    __m256i uv00 = _mm256_loadu_si256((__m256i*)v0);
                    v0 += 32;
                    uv00 = _mm256_sub_epi8(uv00, _mm256_set1_epi8(-128));
                    u00 = uv00;
                ...
                __m128i u000 = _mm_loadu_si128((__m128i*)u0);
                u0 += 16;
                __m128i v000 = _mm_loadu_si128((__m128i*)v0);
                v0 += 16;
            ...
            __m256i dG = _mm256_add_epi16(_mm256_mulhi_epi16(u00, _mm256_set1_epi16(UG)),
                                          _mm256_mulhi_epi16(v00, _mm256_set1_epi16(VG)));
            ...
            _mm256_storeu_si256((__m256i*)rgb1 + 3, b[3]);
            rgb1 += 16 * 8;
        }
        if (componentRGB == 4) continue;
#elif HAVE_SSE2
        int halfWidth8 = (componentRGB == 4) ? halfWidth / 8 : 0;
        for (int w = 0; w < halfWidth8; ++w) {
            __m128i y00lh = _mm_loadu_si128((__m128i*)y0);
            y0 += 16;
            __m128i y10lh = _mm_loadu_si128((__m128i*)y1);
            y1 += 16;
            __m128i y00;
            __m128i y01;
            __m128i y10;
            ...
            if (interleaved) {
                if (firstU) {
                    __m128i uv00 = _mm_loadu_si128((__m128i*)u0);
                    u0 += 16;
                    uv00 = _mm_sub_epi8(uv00, _mm_set1_epi8(-128));
                    u00 = _mm_slli_epi16(uv00, 8);
                    v00 = uv00;
                } else {
                    __m128i uv00 = _mm_loadu_si128((__m128i*)v0);
                    v0 += 16;
                    uv00 = _mm_sub_epi8(uv00, _mm_set1_epi8(-128));
                    u00 = uv00;
                ...
                __m128i u000 = _mm_loadl_epi64((__m128i*)u0);
                u0 += 8;
                __m128i v000 = _mm_loadl_epi64((__m128i*)v0);
                v0 += 8;
                u000 = _mm_sub_epi8(u000, _mm_set1_epi8(-128));
                v000 = _mm_sub_epi8(v000, _mm_set1_epi8(-128));
            ...
            __m128i dG =
                    _mm_add_epi16(_mm_mulhi_epi16(u00, _mm_set1_epi16(UG)), _mm_mulhi_epi16(v00, _mm_set1_epi16(VG)));
