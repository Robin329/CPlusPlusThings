...
int main() {
    ...
    Employee e1(1, (char *)"Zhangsan", 23, 2320);
    Employee e2(2, (char *)"Lisi", 32, 3210);
    Employee e3(3, (char *)"WangWu", 34, 2220);
    Employee e4(4, (char *)"Liuliu", 27, 1220);
    ...
    Employee e5(3, (char *)"WangWu", 40, 2220);
