...
unsigned short crc16_(char *data_p, unsigned short length) {
    unsigned char i;
    unsigned int data;
    unsigned int crc = 0xffff;
    if (length == 0) return (unsigned short)(crc);
    do {
...
static unsigned char gpcTestData2[] = {0xFF, 0x00, 0x00, 0x00, 0x1E, 0xF0, 0x1E, 0xC7, 0x4F, 0x82, 0x78, 0xC5,
                                       0x82, 0xE0, 0x8C, 0x70, 0xD2, 0x3C, 0x78, 0xE9, 0xFF, 0x00, 0x00, 0x01};
static unsigned char gpcTestData3[] = {0xFF, 0x00, 0x00, 0x02, 0xB9, 0xDC, 0xF3, 0x72, 0xBB, 0xD4, 0xB8, 0x5A,
...
int CalculateCRC16_main(void) {
    ...
    sCRC16Result = CalculateCRC16(gpcTestData2, NUMBER_OF_TEST_DATA2_BYTES);
    printf("[CalculateCRC16] Checksum CS[15:0] = 0x%04X\n", sCRC16Result);
    sCRC16Result = crc16((const char*)gpcTestData3, NUMBER_OF_TEST_DATA3_BYTES);
    printf("[crc16] Checksum CS[15:0] = 0x%04X\n", sCRC16Result);
    return 0;
}
