...
public:
    ...
    //
    //  So, if we think reversely, if the balloon i is the last balloon of all to
    //  burst, the left and right section now has well defined boundary and do not
    //  affect each other! Therefore we can do either recursive method with
    //  memoization
    //
