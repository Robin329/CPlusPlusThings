 ...
 *i​​​​​​th​​​​ user knows, and friendships[i] =
 *[u​​​​​​i​​​, v​​​​​​i] denotes a friendship
 *between the users u​​​​​​​​​​​ i​​​​​ and vi.
 *
 ...
 *to teach. Note that friendships are not transitive, meaning if x is a friend
 *of y and y is a friend of z, this doesn't guarantee that x is a friend of z.
 *
 * Example 1:
 *
