 ...
 *the given prime list primes of size k. For example, [1, 2, 4, 7, 8, 13, 14,
...
//    }
//
// The logic of solution is exacly same for both., except that instead of 3
// numbers you have k numbers to consider.
//
//
//
class Solution {
