 ...
 *to process the j^th task starting from the j^th second beginning with the 0^th
 *task at second 0. To process task j, you assign it to the server with the
 *smallest weight that is free, and in case of a tie, choose the server with the
 * smallest index. If a free server gets assigned task j at second t, it will be
 *free again at the second t + tasks[j].
 *
