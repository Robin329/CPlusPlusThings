 ...
 *the prefix are equal. Pick a non-empty suffix from the string s where all the
 *characters in this suffix are equal. The prefix and the suffix should not
 *intersect at any index. The characters from the prefix and suffix must be the
 *same. Delete both the prefix and the suffix.
 *
