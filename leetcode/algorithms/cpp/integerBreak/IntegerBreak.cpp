...
class Solution {
public:
    // As the hint said, checking the n with ranging from 7 to 10 to discover the
    // regularities. n = 7,    3*4 = 12 n = 8,  3*3*2 = 18 n = 9,  3*3*3 = 27 n =
    // 10, 3*3*4 = 36 n = 11, 3*3*3*2 = 54
    //
