 ...
 *of 2 is at least 1. The answer is 3. Query = [3,3]: There are no rooms with a
 *size of at least 3, so the answer is -1. Query = [5,2]: Room number 3 is the
 *closest as abs(3 - 5) = 2, and its size of 2 is at least 2. The answer is 3.
 *
 * Example 2:
 *
 ...
 *of 3 is at least 3. The answer is 2. Query = [2,4]: Room numbers 1 and 3 both
 *have sizes of at least 4. The answer is 1 since it is smaller. Query = [2,5]:
 *Room number 3 is the only room with a size of at least 5. The answer is 3.
 *
 * Constraints:
 *
 * 	n == rooms.length
...
public:
    vector<int> closestRoom(vector<vector<int>> &rooms, vector<vector<int>> &queries) {
        ...
        // sorted the rooms by size by descending order, because query the minimal
        // size.
