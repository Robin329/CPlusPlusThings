...
//
//    1) if a substring from 0 to i is a word, then take the rest substring to
//    evaluate. 2) during the recursion, keep tracking the result
//
//  For example:
//
//    s = "catsanddog",
...
//
//
// However, the recursive could produce a lot duplicated calculation, we need
// use a cache to avoid.
//
