 ...
 *to 0. For example, if s = "3456" and a = 5, s becomes "3951". Rotate s to the
 *right by b positions. For example, if s = "3456" and b = 1, s becomes "6345".
 *
...
private:
    ...
    void rotate_str(string &s, int n) { std::rotate(s.begin(), s.begin() + n, s.end()); }
