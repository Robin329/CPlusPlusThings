 ...
 *"SFO"]] Return ["JFK", "MUC", "LHR", "SFO", "SJC"].
 *
 *     Example 2:
 *     tickets =
...
/*
 ...
 for examples:
    1) [["JFK", "PEK"], ["JFK", "SHA"], ["SHA", "JFK"]], which has two
 itineraries: a) JFK -> PEK, b) JFK -> SHA -> JFK -> PEK The a) is smaller than
 b), because PEK < SHA, however the b) is correct answer. So, it means we need
 use all of tickets.
