// Source :
// https://leetcode.com/problems/evaluate-the-bracket-pairs-of-a-string/ Author
// : Hao Chen Date   : 2021-03-28
 ...
 *string array knowledge where each knowledge[i] = [keyi, valuei] indicates that
 *key keyi has a value of valuei.
 *
 ...
 *[["name","bob"],["age","two"]] Output: "bobistwoyearsold" Explanation: The key
 *"name" has a value of "bob", so replace "(name)" with "bob". The key "age" has
 *a value of "two", so replace "(age)" with "two".
 *
 * Example 2:
 *
