// Source :
// https://leetcode.com/problems/determine-color-of-a-chessboard-square/ Author
// : Hao Chen Date   : 2021-04-06
...
class Solution {
public:
    bool squareIsWhite(string coordinates) { return (coordinates[0] - 'a' + 1) % 2 != (coordinates[1] - '0') % 2; }
};
