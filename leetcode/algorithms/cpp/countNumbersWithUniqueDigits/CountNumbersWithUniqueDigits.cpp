 ...
 * Input: 2
 * Output: 91
 * Explanation: The answer should be the total numbers in the range of 0 &le; x
...
//   - the second place could be [0-9] with excluding the first digit, which is
//   10-1=9 choices.
//   - the third place could be [0-9] with excluding the 1st and 2nd digits,
//   which is 10-2=8 choices.
// So, three digits has 9*9*8 unique digits.
//
// After adds the 1 digit unique number,and 2 digits unique number, we can have
// the result:
//
