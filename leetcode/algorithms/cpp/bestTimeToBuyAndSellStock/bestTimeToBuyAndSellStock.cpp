...
public:
    ...
    //    2) if prices[end] - prices[begin] >  0, then move the "end" pointer to
    //    next 3) if prices[end] - prices[begin] <= 0, then move the "begin"
    //    pointer to current posstion. 4) tracking the max profit
    //
    // Notes:
