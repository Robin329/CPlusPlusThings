// Source :
// https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree/ Author
// : Hao Chen Date   : 2015-07-17
...
public:
    ...
    TreeNode *lowestCommonAncestor02(TreeNode *root, TreeNode *p, TreeNode *q) {
        ...
        // left!=NULL && right !=NULL, which means `p` & `q` are seperated in left
        // and right tree.
        return root;
    }
