 ...
 *       becasue we have the highest bar in right, so, any bar higher than its
 * right bar(s) can contain the water. 3) traverse the bar from right the
 * highest bar. becasue we have the highest bar in left, so, any bar higher than
 * its left bar(s) can contain the water.
 *
