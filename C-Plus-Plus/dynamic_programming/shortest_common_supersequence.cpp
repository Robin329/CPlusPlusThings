/**
 * @file
 * @brief SCS is a string Z which is the shortest supersequence of strings X and
 * Y (may not be continuous in Z, but order is maintained).
 *
 * @details
...
/**
 * Function implementing Shortest Common Super-Sequence algorithm using look-up
 * table method.
